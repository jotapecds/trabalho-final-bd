...
--
-- Dumping data for table `bairro_biblioteca`
--
...
--
-- Dumping data for table `bairro_patrimonio`
--
...
(6, 'R. 2 de Dezembro, 41', 15, 'R. 2 de Dezembro, 41'),
(7, 'Pr. do Flamengo, 88', 15, 'Edifício Flamengo');
...
--
ALTER TABLE `patrimonio`
  MODIFY `id_patrimonio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
